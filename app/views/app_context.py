# app/views/app_context.py

TRADUCCIONES = {
    
        # Agregar en la sección TERMINAL BIOMÉTRICA
    ...
    # Catálogo usuarios — badges de rol
    ...
    "⚙️   Configuración Cuenta":                    {"en": "⚙️   Account Settings"},
    "⚙️ Configuración Cuenta":                      {"en": "⚙️ Account Settings"},
    ...
    # DASHBOARD — tabla últimos accesos
    ...
    # GESTIÓN DE USUARIOS — formulario secciones
    "Editar Registro":                              {"en": "Edit Record"},
    "✏️ Editar Registro":                           {"en": "✏️ Edit Record"},
    ...
    "Identificación":                               {"en": "Identification"},
    "⚙️ Estado del usuario":                        {"en": "⚙️ User Status"},
    "Usuario activo":                               {"en": "Active user"},

    # GESTIÓN DE USUARIOS — labels de campos
    ...
    # GESTIÓN DE FACULTADES — formulario
    "Editar Facultad":                              {"en": "Edit Faculty"},
    "✏️ Editar Facultad":                           {"en": "✏️ Edit Faculty"},
    "Crear Nueva Facultad":                         {"en": "Create New Faculty"},
    "➕ Crear Nueva Facultad":                      {"en": "➕ Create New Faculty"},
    "Nombre de la Facultad":                        {"en": "Faculty Name"},
    "🏛️ Nombre de la Facultad":                    {"en": "🏛️ Faculty Name"},
    "Estado":                                       {"en": "Status"},
    "⚙️ Estado":                                    {"en": "⚙️ Status"},
    "Activa":                                       {"en": "Active"},
    "Inactiva":                                     {"en": "Inactive"},
    ...
    # GESTIÓN DE CARRERAS — formulario
    "Editar Carrera":                               {"en": "Edit Career"},
    "✏️ Editar Carrera":                            {"en": "✏️ Edit Career"},
    ...
    # Terminal — mensajes de detección y estado
...
class AppContext:
    ...
    def t(cls, texto: str) -> str:
        ...
        # Aviso en consola durante desarrollo — quitar en producción
